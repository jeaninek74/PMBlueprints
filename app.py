...
try:
    ...
    from routes.run_category_fix import run_category_fix_bp
    ...
    app.register_blueprint(run_category_fix_bp)
    ...
    app.register_blueprint(migrate_bp, url_prefix='/admin')  # Database migration routes
